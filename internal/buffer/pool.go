...
// New creates a Buffer in its own default pool. Workloads that need shared RAM
// or disk budgets should create a Pool and call Pool.NewBuffer instead.
func New(cfg Config) (*Buffer, error) {
	return NewPool(PoolConfig{Name: "default"}).NewBuffer(cfg)
}
